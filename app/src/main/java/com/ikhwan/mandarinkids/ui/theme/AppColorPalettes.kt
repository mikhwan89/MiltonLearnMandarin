...
val DefaultPalette = AppColorScheme(
    ...
    categoryEssentials      = ColorPair(Color(0xFFD0E8F8), Color(0xFFE4F2FB)),
    categoryAtSchool        = ColorPair(Color(0xFFD4EDD0), Color(0xFFE6F4E4)),
    categorySchoolSubjects  = ColorPair(Color(0xFFE8E4F5), Color(0xFFF2EFF9)),
    categoryFoodAndEating   = ColorPair(Color(0xFFFFDDB5), Color(0xFFFFEDD4)),
    categoryFeelingsHealth  = ColorPair(Color(0xFFF5E0E0), Color(0xFFFAEEEE)),
    categoryPlayHobbies     = ColorPair(Color(0xFFD5EDD5), Color(0xFFE6F5E6)),
    categoryHome            = ColorPair(Color(0xFFB8E4F0), Color(0xFFD4EFF8)),
    categoryOutAndAbout     = ColorPair(Color(0xFFFFF0B3), Color(0xFFFFF8D9)),
...
val OceanPalette = AppColorScheme(
    ...
    answerCorrectText = SharedAnswerCorrectText,
    answerWrongText   = SharedAnswerWrongText,
    categoryEssentials      = ColorPair(Color(0xFFB2EBF2), Color(0xFFD4F5F9)),
    categoryAtSchool        = ColorPair(Color(0xFFB2DFDB), Color(0xFFCCEAE7)),
    categorySchoolSubjects  = ColorPair(Color(0xFFC5CAE9), Color(0xFFDDE0F4)),
    categoryFoodAndEating   = ColorPair(Color(0xFFFFF9C4), Color(0xFFFEFDE8)),
    categoryFeelingsHealth  = ColorPair(Color(0xFFFFCCBC), Color(0xFFFFE5D9)),
    categoryPlayHobbies     = ColorPair(Color(0xFFC8E6C9), Color(0xFFDCF0DC)),
    categoryHome            = ColorPair(Color(0xFF80DEEA), Color(0xFFB2EBF2)),
    categoryOutAndAbout     = ColorPair(Color(0xFFFFF9C4), Color(0xFFFEFDE8)),
...
val SunsetPalette = AppColorScheme(
    ...
    answerCorrectText = SharedAnswerCorrectText,
    answerWrongText   = SharedAnswerWrongText,
    categoryEssentials      = ColorPair(Color(0xFFFFCCBC), Color(0xFFFFE5D9)),
    categoryAtSchool        = ColorPair(Color(0xFFDCEDC8), Color(0xFFEEF6E2)),
    categorySchoolSubjects  = ColorPair(Color(0xFFF8BBD0), Color(0xFFFDE8EE)),
    categoryFoodAndEating   = ColorPair(Color(0xFFFFE082), Color(0xFFFFF3E0)),
    categoryFeelingsHealth  = ColorPair(Color(0xFFFFAB91), Color(0xFFFFCCBC)),
    categoryPlayHobbies     = ColorPair(Color(0xFFC8E6C9), Color(0xFFDCF0DC)),
    categoryHome            = ColorPair(Color(0xFFFFCC80), Color(0xFFFFE0A0)),
    categoryOutAndAbout     = ColorPair(Color(0xFFFFE082), Color(0xFFFFF3E0)),
...
val ForestPalette = AppColorScheme(
    ...
    answerCorrectText = SharedAnswerCorrectText,
    answerWrongText   = SharedAnswerWrongText,
    categoryEssentials      = ColorPair(Color(0xFFA5D6A7), Color(0xFFC2E6C4)),
    categoryAtSchool        = ColorPair(Color(0xFF80CBC4), Color(0xFFB0E0DC)),
    categorySchoolSubjects  = ColorPair(Color(0xFFD7CCC8), Color(0xFFEFEBE9)),
    categoryFoodAndEating   = ColorPair(Color(0xFFFFE0B2), Color(0xFFFFF3E0)),
    categoryFeelingsHealth  = ColorPair(Color(0xFFFFAB91), Color(0xFFFFCCBC)),
    categoryPlayHobbies     = ColorPair(Color(0xFFC5E1A5), Color(0xFFDCEDC8)),
    categoryHome            = ColorPair(Color(0xFFB2DFDB), Color(0xFFCCE8E5)),
    categoryOutAndAbout     = ColorPair(Color(0xFFFFE0B2), Color(0xFFFFF3E0)),
...
val BerryPalette = AppColorScheme(
    ...
    answerCorrectText = SharedAnswerCorrectText,
    answerWrongText   = SharedAnswerWrongText,
    categoryEssentials      = ColorPair(Color(0xFFE1BEE7), Color(0xFFF0DDF5)),
    categoryAtSchool        = ColorPair(Color(0xFFF8BBD0), Color(0xFFFCE4EC)),
    categorySchoolSubjects  = ColorPair(Color(0xFFCE93D8), Color(0xFFE4C4EC)),
    categoryFoodAndEating   = ColorPair(Color(0xFFFFE082), Color(0xFFFFF3E0)),
    categoryFeelingsHealth  = ColorPair(Color(0xFFFFAB91), Color(0xFFFFCCBC)),
    categoryPlayHobbies     = ColorPair(Color(0xFFC8E6C9), Color(0xFFDCF0DC)),
    categoryHome            = ColorPair(Color(0xFFB39DDB), Color(0xFFD1C4E9)),
    categoryOutAndAbout     = ColorPair(Color(0xFFFFE082), Color(0xFFFFF3E0)),
...
val NightPalette = AppColorScheme(
    ...
    categoryEssentials      = ColorPair(Color(0xFF1C2C36), Color(0xFF243644)),
    categoryAtSchool        = ColorPair(Color(0xFF182C18), Color(0xFF203820)),
    categorySchoolSubjects  = ColorPair(Color(0xFF222035), Color(0xFF2C2842)),
    categoryFoodAndEating   = ColorPair(Color(0xFF2A2610), Color(0xFF362E14)),
    categoryFeelingsHealth  = ColorPair(Color(0xFF2C1A1A), Color(0xFF381E1E)),
    categoryPlayHobbies     = ColorPair(Color(0xFF182818), Color(0xFF203220)),
    categoryHome            = ColorPair(Color(0xFF182830), Color(0xFF20323C)),
    categoryOutAndAbout     = ColorPair(Color(0xFF2A2610), Color(0xFF362E14)),
...
val MidnightPalette = AppColorScheme(
    ...
    answerCorrectText = DarkAnswerCorrectText,
    answerWrongText   = DarkAnswerWrongText,
    categoryEssentials      = ColorPair(Color(0xFF142030), Color(0xFF1C2C40)),
    categoryAtSchool        = ColorPair(Color(0xFF0C2422), Color(0xFF122E2C)),
    categorySchoolSubjects  = ColorPair(Color(0xFF14163A), Color(0xFF1C204C)),
    categoryFoodAndEating   = ColorPair(Color(0xFF241C0C), Color(0xFF302610)),
    categoryFeelingsHealth  = ColorPair(Color(0xFF261418), Color(0xFF32181E)),
    categoryPlayHobbies     = ColorPair(Color(0xFF0C2418), Color(0xFF122E1E)),
    categoryHome            = ColorPair(Color(0xFF0E2030), Color(0xFF142A3C)),
    categoryOutAndAbout     = ColorPair(Color(0xFF241C0C), Color(0xFF302610)),
...
val EmberPalette = AppColorScheme(
    ...
    answerCorrectText = DarkAnswerCorrectText,
    answerWrongText   = DarkAnswerWrongText,
    categoryEssentials      = ColorPair(Color(0xFF2E1C0C), Color(0xFF3C2610)),
    categoryAtSchool        = ColorPair(Color(0xFF101C0E), Color(0xFF162812)),
    categorySchoolSubjects  = ColorPair(Color(0xFF200C0E), Color(0xFF2C1012)),
    categoryFoodAndEating   = ColorPair(Color(0xFF2A1A06), Color(0xFF38240A)),
    categoryFeelingsHealth  = ColorPair(Color(0xFF2A0E0E), Color(0xFF361212)),
    categoryPlayHobbies     = ColorPair(Color(0xFF161C08), Color(0xFF1E240C)),
    categoryHome            = ColorPair(Color(0xFF0E1C1A), Color(0xFF142624)),
    categoryOutAndAbout     = ColorPair(Color(0xFF2A1A06), Color(0xFF38240A)),
...
val JunglePalette = AppColorScheme(
    ...
    answerCorrectText = DarkAnswerCorrectText,
    answerWrongText   = DarkAnswerWrongText,
    categoryEssentials      = ColorPair(Color(0xFF0E2020), Color(0xFF142A28)),
    categoryAtSchool        = ColorPair(Color(0xFF102410), Color(0xFF162E16)),
    categorySchoolSubjects  = ColorPair(Color(0xFF1A1A0C), Color(0xFF222212)),
    categoryFoodAndEating   = ColorPair(Color(0xFF201C08), Color(0xFF2A260C)),
    categoryFeelingsHealth  = ColorPair(Color(0xFF221410), Color(0xFF2C1A14)),
    categoryPlayHobbies     = ColorPair(Color(0xFF142014), Color(0xFF1A2C1A)),
    categoryHome            = ColorPair(Color(0xFF0C1E1C), Color(0xFF122826)),
    categoryOutAndAbout     = ColorPair(Color(0xFF201C08), Color(0xFF2A260C)),
...
val DuskPalette = AppColorScheme(
    ...
    answerCorrectText = DarkAnswerCorrectText,
    answerWrongText   = DarkAnswerWrongText,
    categoryEssentials      = ColorPair(Color(0xFF1C1240), Color(0xFF26184E)),
    categoryAtSchool        = ColorPair(Color(0xFF1C0C2A), Color(0xFF261238)),
    categorySchoolSubjects  = ColorPair(Color(0xFF200C38), Color(0xFF2C1048)),
    categoryFoodAndEating   = ColorPair(Color(0xFF281608), Color(0xFF34200C)),
    categoryFeelingsHealth  = ColorPair(Color(0xFF2A0E18), Color(0xFF36121E)),
    categoryPlayHobbies     = ColorPair(Color(0xFF141828), Color(0xFF1A2036)),
    categoryHome            = ColorPair(Color(0xFF141230), Color(0xFF1C1840)),
    categoryOutAndAbout     = ColorPair(Color(0xFF281608), Color(0xFF34200C)),
