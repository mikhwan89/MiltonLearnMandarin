...
interface MasteredWordDao {
    ...
    /** Total distinct words tracked for a specific practice type. */
    @Query("SELECT COUNT(DISTINCT chinese) FROM mastered_words WHERE practiceType = :practiceType")
    fun getTotalCountByType(practiceType: String): Flow<Int>
